 ...
 * $soapclient = new NuSoapClient( string path [ ,mixed NuSoapWsdl] );
 *
...
class NuSoapClient extends NuSoapBase
{
    ...
    var $endpointType = '';            // soap|NuSoapWsdl, empty for WSDL initialization error
     ...
     * constructor
     *
     * @param    mixed $endpoint SOAP server or WSDL URL (string), or NuSoapWsdl instance (object)
     * @param    mixed $wsdl optional, set to 'NuSoapWsdl' or true if using WSDL
    ...
    public function __construct($endpoint, $wsdl = false, $proxyhost = false, $proxyport = false, $proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = '')
    {
        ...
        // make values
        if ($wsdl) {
            if (is_object($endpoint) && (get_class($endpoint) == 'NuSoapWsdl')) {
                $this->wsdl = $endpoint;
    ...
    /**
     * instantiate NuSoapWsdl object and parse NuSoapWsdl file
     *
     * @access    public
     */
    function loadWSDL()
    {
        ...
        $this->wsdl = new NuSoapWsdl('', $this->proxyhost, $this->proxyport, $this->proxyusername, $this->proxypassword, $this->timeout, $this->response_timeout, $this->curl_options, $this->use_curl);
        ...
        switch (true) {
            ...
            case preg_match('/^http/', $this->endpoint):
                ...
                if ($this->persistentConnection == true && is_object($this->persistentConnection)) {
                    ...
                    $http = new NuSoapTransportHttp($this->endpoint, $this->curl_options, $this->use_curl);
     ...
     *
     * @param    mixed $headers String of XML with SOAP header content, or array of NuSoapVal objects for SOAP headers
     * @access   public
     */
     ...
     * allowing user to directly call methods from NuSoapWsdl
     *
    ...
    function getProxy()
    {
        ...
        // transfer current NuSoapWsdl data to the proxy thereby avoiding parsing the NuSoapWsdl twice
