...
class nusoap_server extends NuSoapBase
{
    ...
    var $response = '';
    /**
     * SOAP headers for response (text or array of NuSoapVal or associative array)
     * @var mixed
     * @access public
     */
    var $responseHeaders = '';
     ...
     *
     * @param mixed $wsdl file path or URL (string), or NuSoapWsdl instance (object)
     * @access   public
     */
    function nusoap_server($wsdl = false)
    {
        ...
        if ($wsdl) {
            ...
            if (is_object($wsdl) && (get_class($wsdl) == 'NuSoapWsdl')) {
                $this->wsdl = $wsdl;
                $this->externalWSDLURL = $this->wsdl->wsdl;
                $this->debug('Use existing wsdl instance from ' . $this->externalWSDLURL);
            } else {
                $this->debug('Create wsdl from ' . $wsdl);
                $this->wsdl = new NuSoapWsdl($wsdl);
    ...
    function serialize_return()
    {
        ...
        // if fault
        if (isset($this->methodreturn) && is_object($this->methodreturn) && ((get_class($this->methodreturn) == 'soap_fault') || (get_class($this->methodreturn) == 'NuSoapFault'))) {
    ...
    function parseRequest($headers, $data)
    {
        ...
        if ($err = $parser->getError()) {
            ...
            // else successfully parsed request into NuSoapVal object
        } else {
            // get/set methodname
