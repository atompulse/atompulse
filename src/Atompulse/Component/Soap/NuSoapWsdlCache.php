...
/**
 * caches instances of the NuSoapWsdl class
 *
...
class NuSoapWsdlCache
{
    ...
    /**
     * creates the filename used to cache a NuSoapWsdl instance
     *
     * @param string $wsdl The URL of the NuSoapWsdl instance
    ...
    /**
     * gets a NuSoapWsdl instance from the cache
     *
     * @param string $wsdl The URL of the NuSoapWsdl instance
     * @return object NuSoapWsdl The cached NuSoapWsdl instance, null if the instance is not in the cache
     * @access public
     */
    function get($wsdl)
    {
    ...
    /**
     * adds a NuSoapWsdl instance to the cache
     *
     * @param object NuSoapWsdl $wsdl_instance The NuSoapWsdl instance to add
    ...
    /**
     * removes a NuSoapWsdl instance from the cache
     *
     * @param string $wsdl The URL of the NuSoapWsdl instance
